Feature: Inicios de sesion
  ...
  Scenario: login exitoso
    Given el usuario esta en la pagina de inicio de sesion con el correo de ususario "eve.holt@reqres.in" y la contrasena "pistol"
  ...
  Scenario: login no exitoso
    Given el usuario esta en la pagina de inicio de sesion con el correo de usuario "sydney@fife" sin contrasena
    When cuando el usuario hace una peticion de inicio
